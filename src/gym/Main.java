...
public class Main {
    public static void main(String[] args) throws InstructorNotQualifiedException, DuplicateClientException, InvalidAgeException, ClientNotRegisteredException {
        ...
        gymSecretary.registerClientToSession(c1, s1);
        gymSecretary.registerClientToSession(c1, s2);
        gymSecretary.registerClientToSession(c1, s4);
        gymSecretary.registerClientToSession(c4, s4);
        gymSecretary.registerClientToSession(c1, s3);
        gymSecretary.registerClientToSession(c5, s2);
        gymSecretary.registerClientToSession(c5, s2);

        gymSecretary.registerClientToSession(c1, s5);
        gymSecretary.registerClientToSession(c2, s5);
        gymSecretary.registerClientToSession(c3, s5);
        gymSecretary.registerClientToSession(c4, s5);
        gymSecretary.registerClientToSession(c6, s5);
        gymSecretary.registerClientToSession(c7, s5);
        ...
        gymSecretary.unregisterClient(c2);
        try {
            gymSecretary.registerClientToSession(c2, s3);
        } catch (ClientNotRegisteredException e) {
            System.out.println(e.getMessage());
        }
